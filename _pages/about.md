...
<div style="background-color: #A4925A; padding: 20px;">
  ...
  <div style="background-color: #FFFFFF; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
    ...
    <ul>
      ...
      <li>ECE 6500 Fourier Techniques & Signals Analysis</li>
...
<style>
  .quote-container {
    ...
    align-items: center;
    height: 100vh;
    background-color: #A4925A; /* Background color of the entire quote container */
  }
